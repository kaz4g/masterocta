...
| `MO-RC8-GATE-C-FORMAL-CONTINUOUS-1` | [`MO_RC8_GATE_C_FORMAL_CONTINUOUS_TRIAL.md`](MO_RC8_GATE_C_FORMAL_CONTINUOUS_TRIAL.md) | Formal continuous Gate C trial **NOT_RUN**; second Project required **before PRE freeze** for explicit LOAD |
